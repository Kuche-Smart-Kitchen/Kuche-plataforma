        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm text-secondary md:text-base">
              Perfil oficial de Cocinas Inteligentes Kuche integrado con la API de oEmbed de Meta.
            </p>
          </div>
          <Link
            href={profileUrl}
          ...
          <div className="overflow-hidden rounded-3xl border border-primary/10 bg-white p-4 shadow-xl shadow-black/5">
            ...
            {!embedData?.ok ? (
              <p className="mt-4 text-xs text-secondary">
                Mostrando vista embebida directa de Instagram. Para oEmbed completo de Meta, configura
                credenciales del Graph API.
              </p>
            ) : null}
          </div>
        )}
