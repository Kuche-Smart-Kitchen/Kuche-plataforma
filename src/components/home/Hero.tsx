    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-20 flex h-full w-full items-center">
        <motion.div
          ...
          className="w-full max-w-3xl px-6 pb-24 pt-28 text-left sm:px-10 sm:pt-32 md:max-w-4xl md:px-12 lg:px-16 lg:pt-36"
        >
          <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-white/70 sm:text-xs sm:tracking-[0.35em]">
