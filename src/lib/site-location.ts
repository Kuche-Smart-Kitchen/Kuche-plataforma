...
export const SHOWROOM_ADDRESS_LINE = env.showroomAddress || "Av Universidad España 119, Cd Industrial, Español, 34209 Durango, Dgo.";
...
export function getGoogleMapsEmbedSrc(): string {
  const custom = env.googleMapsEmbedSrc;
